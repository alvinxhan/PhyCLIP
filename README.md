...
* summary-stats_{input_filename}.txt - Tab-delimited file summarizing the clustering output (e.g. % clustered, mean pairwise patristic distance of clades and its dispersion, etc.) of all parameter sets.
* cluster\_{gam\_method}\_{hypo\_test}\_cs\_fdr\_gam\_{input_filename}.txt - Tab-delimited file detailing the clade-ID of every clustered taxon.
* tree\_{gam\_method}\_{hypo\_test}\_cs\_fdr\_gam\_{input_filename}.tre - NEXUS tree with FigTree annotations of clusters.
