...
if __name__ == '__main__':
    ...
    parser.add_argument('--collapse_zero_branch_lengths', default=0, choices=[0, 1], type=int, help='Collapse zero branch lengths of tree prior to running PhyCLIP (default = %(default)s).')
    ...
    parser.add_argument('--gam_method', choices=['MAD', 'Qn'], default='Qn',  help='Robust estimation of dispersion parameter (default = %(default)s).')
    ...
    parser.add_argument('--preQ', default=0, choices=[0, 1], type=int, help='Perform Benjamini-Hochberg corrections of p-values BEFORE filtering nodes < minimum cluster size (advanced option, default = %(default)s).')
